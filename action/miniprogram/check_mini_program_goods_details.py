...
class MiniGoodsDetails(BasePage):
    ...
    def mini_op_goods_share_send_poster_friend(self):
        # 点击微信好友
        self.wait_presence_element(MINI_BUTTON_HOME_SHARE_FRIEND).click()
        # 给中国联通发送海报
    ...
    def mini_op_goods_share_create_poster(self):
        # 下载海报
        self.wait_presence_element(MINI_BUTTON_HOME_SHARE_CREATE_BILL).click()
        time.sleep(5)
        # 下载图片
    ...
    def mini_op_goods_details_adding_cart(self):
        # 加入购物车
        self.wait_presence_element(MINI_BUTTON_GOODS_DETAILS_ADD_CART).click()

    """立即购买+确定"""

    def mini_op_goods_details_buy_now(self):
        # 立即购买
    ...
    def mini_op_goods_details_buy_now_button(self):
        # 立即购买
        self.wait_presence_element(MINI_BUTTON_GOODS_DETAILS_BUYING).click()

    """立即购买页添加数量"""

    def mini_op_goods_details_add_number_buy(self):
        # 立即购买页添加数量
        self.wait_presence_element(MINI_BUTTON_HOME_ADD_CART).click()
